...
replace_var "__NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY__" "${NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY}"
replace_var "__NEXT_PUBLIC_ALLOW_EMAIL_SIGNUP__" "${NEXT_PUBLIC_ALLOW_EMAIL_SIGNUP:-false}"
